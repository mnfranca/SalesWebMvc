...
public class SeedingService
{
  ...
  public void Seed()
  {
    ...
    Seller s1 = new(1, "Bob Brown", "bob@email.com", new DateTime(1998, 4, 21), 1000.00, d1);
    Seller s2 = new(2, "Maria Green", "maria@email.com", new DateTime(1979, 12, 31), 3500.00, d2);
    Seller s3 = new(3, "Alex Grey", "alex@email.com", new DateTime(1988, 1, 15), 2200.00, d1);
    Seller s4 = new(4, "Martha Red", "martha@email.com", new DateTime(1993, 11, 30), 3000.00, d4);
    Seller s5 = new(5, "Donald Blue", "donald@email.com", new DateTime(2000, 1, 9), 4000.00, d3);
    Seller s6 = new(6, "Alex Pink", "alexp@email.com", new DateTime(1997, 2, 4), 3000.00, d2);
